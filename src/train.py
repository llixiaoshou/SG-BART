...
from bart_base import BartForConditionalGeneration
import numpy as np
...
def main(opt, logger):
    ...
    model = BartForConditionalGeneration.from_pretrained('../pre_model/bart-base', asp_config=asp_config).to(device)
