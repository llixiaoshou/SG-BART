...
from onqg.utils.train.Train_org_bart import SupervisedTrainer
from onqg.utils.translate.Translator_org_bart import Translator
...
def main(opt, logger):
    ...
    trainData.batchSize = opt.batch_size
    validData.batchSize =1
    ...
    # opt.edge_vocab_size = graph_vocabularies['edge']['edges++'].size
    ...
    ##### ==================== Prepare Translator ==================== #####
    # print('sequences+++++',sequences)
    # print('seq_vocabularies',seq_vocabularies['tgt'])
    # print('seq_vocabularies',seq_vocabularies['src'])
