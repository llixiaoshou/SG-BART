...
def add_options(parser):
    ...
    parser.add_argument('-train_ans_graph', help="Path to the training source graph data")
    parser.add_argument('-valid_ans_graph', help="Path to the validation source graph data")

    #
    parser.add_argument('-train_ans', default=False, help="Path to the training answer")
    parser.add_argument('-valid_ans', default=False, help="Path to the validation answer")
    #
    ...
    parser.add_argument('-share_vocab', action='store_true', default=False, help="Share source and target vocabulary")
    #
    parser.add_argument('-pretrained', type=str, default='', help="choices: bert-base-uncased, gpt2, etc.")
    parser.add_argument('-pre_trained_vocab', default='', help="Path to the pre-trained vocab file")
    parser.add_argument('-word_vec_size', type=int, default=300)
    parser.add_argument('-batch_size', type=int, default=32)
    #
    ##### ========== Final Results Directory ========== #####

    parser.add_argument('-d_seq_enc_model', help="Output file for the prepared data")
